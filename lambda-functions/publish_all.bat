...
aws lambda update-function-code --function-name makeDailyRaport --zip-file fileb://index.zip
...
aws lambda update-function-configuration --function-name makeDailyRaport --handler workers/update_statistics_worker.lambda_handler